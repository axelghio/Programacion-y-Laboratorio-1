...
int main()
{
    ...
    do
    {
        ...
        case 2:
            if(flag == 1)
            {
                modificarEmpleado(empleados, MAX_EMPLEADOS,sectores,TAM_SECTORES);
            }
            else
            {
        ...
        case 3:
            if(flag == 1)
            {
                bajaEmpleados(empleados,MAX_EMPLEADOS);
            }
            else
            {
                printf("No se puede dar de baja ningun empleado hasta haber realizado un alta primero.\n");
                system("pause");
            }
            break;
        case 4:
            ...
            {
                printf("No se puede mostrar los empleados hasta haber realizado un alta primero.\n");
                system("pause");
            }
            break;
        case 5:
